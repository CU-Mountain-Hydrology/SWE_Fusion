...
\indent Due to a low percentage of sensors with greater than zero inches of SWE in the South Continental region, some basins that are in both the North and South continental regions have been excluded. The Upper Green basin has been included, however the SWE values within the Uinta mountains may be inaccurate and falsely impacting the percent of average and SWE volume values for the basin.\\
...
\noindent Due to a low percentage of sensors with greater than zero inches of SWE in the South Continental domain, we will not be publishing SWE data nor percentage of average values for the region this week.
...
\indent Due to a low percentage of sensors with greater than zero inches of SWE in Nevada and the surrounding southwest states, we will not be publishing SWE data nor percentage of average values for Nevada this week.\\
...
\noindent Due to a low percentage of sensors with greater than zero inches of SWE in the Sierra Nevada domain, we will not be publishing a Sierra Nevada report this week, nor providing estimated SWE data for the region. Previous reports and data for the Sierra Nevada can be found \href{https://github.com/CU-Mountain-Hydrology/SierraNevada/tree/main/WY_{{ year }}}{\underline{here.}}\\
