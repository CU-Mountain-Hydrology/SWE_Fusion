...
\begin{tabular}{@{\hspace{10pt}}p{2.6cm}{% for _ in range(flat_cols|length) %}c{% endfor %}@{\hspace{10pt}}}
    {# ===================== TITLE ===================== #}
    \toprule
    ...
    {# ===================== FOOTER ===================== #}
    \bottomrule
    \multicolumn{ {{ total_cols }} }{@{\hspace{10pt}}l}{\footnotesize* This is a comparison to the SNODAS (SNOw Data Assimilation System) nationwide product from the National Weather Service.} \\[-4pt]
