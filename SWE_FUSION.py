...
prev_model_run_WW = "ASO_BiasCorrect_RT_CanAdj_rcn_woCCR_nofscamskSens_UseThis"
...
#                       Difference=difference, prev_report_date=prev_rundate, prev_model_run=prev_model_run)
# # clear memory
# sleep(30)
# clear_arcpy_locks()
#
...
if biasCorrection == "Y" and len(SNM_ASO_biasCorr_basins) > 0:
    ...
    WW_tables_for_report(rundate=rundate, modelRunName=f"ASO_BiasCorrect_{ChosenModelRun_WW}", averageRunName=model_woCCR, results_workspace=WW_results_workspace + f"{rundate}_results/",
                         ...
                         prev_rundate=prev_rundate, prev_tables_workspace=WW_prev_tables_workspace, surveys_use=True, survey_date=survey_date)
else:
    ...
    SNM_tables_for_report(rundate=rundate, modelRunName=ChosenModelRun_SNM, averageRunName=model_woCCR, results_workspace=SNM_results_workspace + f"{rundate}_results/",
                          ...
                          aso_symbol= aso_symbol, prev_rundate=prev_rundate, prev_tables_workspace=SNM_prev_tables_workspace, surveys_use=True, survey_date=survey_date)
