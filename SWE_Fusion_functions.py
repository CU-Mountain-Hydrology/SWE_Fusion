...
def tables_and_layers_SNM(year, rundate, mean_date, prev_report_date, SNM_results_workspace, WW_model_run, run_type,
                          snap_raster, WW_results_workspace, watermask, glacier_mask, domain_mask, Difference, bias_model_run=None):
    # create directory
